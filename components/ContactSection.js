...
export default function ContactSection() {
  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-zinc-100 via-red-50 to-zinc-200 dark:from-zinc-900 dark:via-zinc-800 dark:to-zinc-900 py-16 px-4">
      <div className="relative w-full max-w-lg bg-white/80 dark:bg-zinc-900/80 rounded-3xl shadow-2xl p-8 md:p-12 backdrop-blur-md border border-zinc-200 dark:border-zinc-800">
        <div className="flex flex-col items-center mb-8">
          <span className="text-5xl text-red-500 animate-bounce mb-2"><FaPaperPlane /></span>
          <h2 className="text-3xl md:text-4xl font-bold text-center text-zinc-900 dark:text-white mb-2">Let's Connect!</h2>
          <p className="text-zinc-600 dark:text-zinc-300 text-center">Send me a message and I'll get back to you soon.</p>
        </div>
