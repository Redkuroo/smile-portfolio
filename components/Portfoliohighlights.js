...
<div className="sm:hidden flex flex-col items-center gap-4 mb-6 px-2">
  ...
  className="w-full max-w-md mx-auto bg-white rounded-2xl shadow-md border border-gray-200 overflow-hidden group relative"
>
    ...
    {projects.map((_, i) => (
      <button
        ...
        className={`w-2.5 h-2.5 rounded-full transition-all duration-300 ${
          i === mobileIndex ? 'bg-red-500 scale-125' : 'bg-gray-300'
        }`}
